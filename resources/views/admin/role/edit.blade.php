                        ...
                        <div class="card-body">
                          ...
                          <div id="pay-invoice">
                              <div class="card-body">
                                ...
                                @endif
                                  {{ Form::open(array('url'=>['back/role/edit',$data->id],'method' => 'PUT')) }}
                                    ...
                                    <div class="form-group">
                                        ...
                                        {{Form::select('permission[]',$permission,$selectedPermission,['class'=>'form-control mySelect','data-placeholder'=>'Select Permission','multiple'] )}}
                                    </div>
