                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-puzzle-piece"></i><a href="">List</a></li>
                            <li><i class="fa fa-id-badge"></i><a href="{{url('back/permission/create')}}">Create</a></li>
                            <li><i class="fa fa-bars"></i><a href="ui-tabs.html">Edit</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-puzzle-piece"></i><a href="{{url('back/category')}}">List</a></li>
                            <li><i class="fa fa-id-badge"></i><a href="{{url('back.category.create')}}">Create</a></li>
                            <li><i class="fa fa-bars"></i><a href="{{url('back.category.edit')}}">Edit</a></li>
                        </ul>
                    </li>
